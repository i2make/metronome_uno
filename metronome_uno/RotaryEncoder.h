...
public:
  ...
  Direction getDirection(); // -1, 0, 1 중 하나를 리턴

  // adjust the current position
  void setPosition(long newPosition);

  // call this function every some milliseconds or by using an interrupt for handling state changes of the rotary encoderBpm.
  void tick(void);
...
private:
  int _pin1, _pin2; // Arduino pins used for the encoderBpm.
